...
void SoundMgr::Init(){
	this->device = alcOpenDevice(NULL);
		...
		unsigned int sid;
	        //background music
		std::string filename = "data/watercraft/sounds/backgroundMusic.mp3";
...
bool SoundMgr::initWatercraftSounds(){
	...
	std::string selectionFilename = "data/watercraft/sounds/clong.wav";
	...
	Entity381* et = engine->entityMgr->entities[0];
/*
